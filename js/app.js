...
let slider = new Swiper('.slider-mainscreen__wrapper', {
	effect: 'fade',
	autoplay: {
		delay: 7000,
...
$('.header-info__close').click(function () {
	...
	let hoverContent = movie.find('.hover-movie__content');
	let movieContent = movie.find('.movie__content');

	infoHover.toggleClass("_active");
	hoverContent.toggleClass("_active");
	movieContent.toggleClass("_active");
});

$('.movie').mouseenter(function () {
	let hoverContent = $(this).find('.hover-movie__content');

	hoverContent.addClass("_active");
});

$('.movie').mouseleave(function () {
	let hoverContent = $(this).find('.hover-movie__content');
	let movieContent = $(this).find('.movie__content');
	let infoHover = $(this).find('.hover-movie__info');

	hoverContent.removeClass("_active");
	movieContent.addClass("_active");
	infoHover.removeClass("_active");
});

$('.hover-movie__view').click(function () {
	let movie = $(this).closest('.movie');
...
let blockViewButton = $('.tabs-movies__block-view');
let lineViewButton = $('.tabs-movies__line-view');
let blockRow = $('.block-tabs__row');
let movieContent = $('.movie__content');
let movieIbg = $('.movie__ibg');
let hoverLineContent = $('.hover-movie__content');

blockViewButton.click(function () {
	blockRow.removeClass('_line');
	movieContent.removeClass('_line');
	movieIbg.removeClass('_line');
	hoverLineContent.removeClass('_line');

	$(this).addClass("_active");
	lineViewButton.removeClass("_active");
});

lineViewButton.click(function () {
	blockRow.addClass('_line');
	movieContent.addClass('_line');
	movieIbg.addClass('_line');
	hoverLineContent.addClass('_line');

	$(this).addClass("_active");
	blockViewButton.removeClass("_active");
});
